...
contract MedicalStorage {
  ...
  function findDoctorIndex(
    ...
    // Return a default value when no matching doctor is found
    return -1;
}
...
function findPatientIndex(
    ...
    // Return a default value when no matching patient is found
    return -1;
}
...
function checkPatientAlreadyExists(
    ...
    // Return false if the patient is not found
    return false;
}
